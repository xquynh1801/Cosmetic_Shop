...
@EnableWebSecurity
@Configuration
public class WebSecurityConfig544 extends WebSecurityConfigurerAdapter {
    @Autowired
    private AuthenticationEntryPoint jwtAuthenticationEntryPoint;

    @Autowired
    private JwtRequestFilter544 jwtRequestFilter544;

    @Autowired
    private JwtUserDetailsService544 jwtUserDetailsService544;
